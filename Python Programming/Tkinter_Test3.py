...
"""class WidgetDemo:
    def __init__(self):
        ...
        rbYellow=Radiobutton(frame1,text="yellow",bg="yellow",variable=self.v2,value=2,command=processRadioButton)
        ...
        btGetName=Button(frame2,text="Get Name",command=processButton)
        message=Message(frame2,text="It's demo widget")
        ...
        text.insert(END,"zzzzzzzzzzzzzzzzzzzzz")
        window.mainloop()
